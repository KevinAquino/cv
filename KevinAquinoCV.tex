...
%    Monash University 770 Blackburn Rd, \\
...
\begin{minipage}[t]{0.5\textwidth}
\parbox[t]{2cm}{\textbf {Mobile:}\\ \textbf{Phone:}\\ \textbf{Email:}\\ \textbf{Homepage:}}
\parbox[t]{8cm}{ +61 (0) 421 851 157 \\+61 (0) 421 851 157\\
kevin.aquino@sydney.edu.au \\
~\url{https://kevinaquino.github.io}%{http://www.physics.usyd.edu.au/~aquino/}}
}
...
Employed as a research fellow at the University of Sydney working on modelling and the following roles:
\begin{itemize}
\item
Employing and developing physiological models to understand resting state fMRI networks
\item
Supervising Honours, and PhD students (from Monash University and the University of Sydney)
\item
Training and mentoring Junior postdoctoral fellows
\end{itemize}}

\entry
{2019 -- }
{Kevin Aquino: Biomedical and Consulting ABN: 56 701 124 137}
{Sydney, Australia.}
{\emph{Lead consultant}\\
Self employed as a consultant, specialising in biomedical imaging and data analytics. Clients include:
\begin{itemize}
\item
In my capacity as a biomedical consultant: A neurology startup in Palo Alto, California, USA.
\item
In my capacity as a neuroimgaing consultant: Pharmaceutical company based in California, USA.
\end{itemize}
}
...
{BrainKey Inc}
{California, USA}
{\emph{Medical image analyst}\\
Employed as senior scientist to undergo extensive large scale image analysis, predictive modelling, and lead research. My role includes validation of existing frameworks and leading a remote quality assurance team of five. 
}
%{2015 --}
%{Sir Peter Mansfield Imaging Center}
...
{\emph{Research Fellow, Head of Computational Modeling, July 2017 -- December 2020}\\
Worked at the Turner Institute working on large scale brain modelling, de-noising resting state fMRI, imaging analytics at the Neural systems and Behavior lab (Primary Investigator Alex Fornito)}
...
Note * indicates senior author/co- senior author. 

\begin{enumerate}
\item
\paper{Deco, G., Kringlebach, M., Arnatkeviciute, A., Oldham, S., Sabaroedin, K., Rogasch, N. C., \ka*, Fornito, A.}{2021}{Dynamical consequences of regional heterogeneity in the brain?s transcriptional landscape}{Science Advances}{7}{eabf4752}

\item
\preprint{Oldham, S., Fulcher, B. D., \ka, Arnatkeviciute, A., Paquola, C., Shishegar, R., \& Fornito A.}{2021}{Modeling spatial, developmental, physiological, and topological constraints on human brain connectivity}{bioRxiv}

\item
\preprint{Chen, Y., Arnatkeviciute, A., McTavish, E., Pang J., Suo C., Fornito, A. \& \ka*}{2021}{The individuality of shape asymmetries of the human cerebral cortex}{bioRxiv}

\item
\paper{\pr, Henderson, J., Gabay N. C., \ka, Babaie-Janvier, T., \& Gao, X. }{2021}{Determination of Dynamic Brain Connectivity via Spectral Analysis}{Frontiers in Human Neuroscience}{15}{655576}

\item
\preprint{\ka, Fulcher, B. D., Oldham S., Parkes L. M., Gollo, L., Deco, G., \& Fornito F.}{2021}{On the intersection between data quality and dynamical modelling of large-scale fMRI signals}{bioRxiv}

\item
\paper{Sabaroedin, K., Razi, A., Chopra, S., Tran, A., Pozaruk,A., Chen, A., Finlay, A., Nelson, N., Allott, K., Alvarez-Jimenez, M., Graham, J., Baldwin, L., Tahtalian, S., Yuen, H., Harrigan, S., Cropley, V.,  Sharma, S., Saluja, B., Williams, R., Pantelis, C., Wood, S. J., O'Donoghue, B., Francey, S., McGorry, P., \ka* \& Fornito A}{2021}{Effective Connectivity of Fronto-Striato-Thalamic Circuitry Across the Psychosis Continuum}{Biological Psychiatry}{89 9}{S356}

\item
\paper{Arnatkeviciute, A, Fulcher, B.F, Oldham, S., Tiego, J., Paquola, C., Gerring, Z.F., \ka,  et al.}{2021}{Genetic influences on hub connectivity of the human connectome}{Nature Communications}{12}{4237}

\item
\paper{\ka, Fulcher B.F., Parkes, L., Sabaroedin, K., \& Fornito, A.}{2020}{Identifying and removing widespread signal deflections from fMRI data: Rethinking the global signal regression problem}{Neuroimage}{212}{116614}
\item
...
\begin{enumerate}
\item
Organized an educational course to teach Dynamic Causal modelling and ordinary differential equations. Lectures were made online at \url{https://www.youtube.com/watch?v=q-yypnHgCII} and have reached over 250 hours of viewing time.
\item
